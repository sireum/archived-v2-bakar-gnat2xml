installed mingw-get-inst-20120426.exe via http://sourceforge.net/projects/mingw/files/Installer/mingw-get-inst/

installed gnatpro at C:\GNATPRO\7.2.0w-20121129.  Under command shell, cd'ed into asis-7.2.0w-src directory
...
Went back to command shell.  Added C:\opt\bin to PATH. cd'ed into gnat2xml-7.2.0w-src
...
Contents of final config.bat used when building gnat2xml
